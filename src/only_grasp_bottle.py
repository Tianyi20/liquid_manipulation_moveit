...
if __name__ == '__main__':    
    try:
        ...
        #bottle_pose.pose.position.x = bottle_pose.pose.position.x - 0.05
        ...
        initial_bottle_pose.pose.position.z = 0.05
        ...
        pre_grasping_pose.pose.position.z = 0.07
        ...
        grasping_pose.pose.position.z = 0.07
