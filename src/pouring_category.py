...
if __name__ == '__main__':
    try:
        ...
        ## here the euler added is: z -> y -> x
        tip_position_rotate = robot.rotation_plus_euler(current_pose= copy.deepcopy(tip_position), euler_added= [0,0,1]) ##here is: x, y, z
        wpose = robot.cal_ee_from_tip(copy.deepcopy(tip_position_rotate))
        robot.move_to_pose(wpose)
